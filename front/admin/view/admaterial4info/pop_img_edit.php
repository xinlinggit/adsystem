...
<form class="layui-form layui-form-pane" action="" method="post" id="editForm" enctype="multipart/form-data" style="margin-left:30px;">
    <div class="layui-tab-item layui-show layui-form-pane" style="margin-top:20px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="">
                <input type="radio" class="field-type" lay-filter="type" name="" value="3" title="图文" checked />
            </div>
        </div>
        <div class="layui-form-item" id="info_pic_box" style="display: block;">
            ...
            <div class="">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input field-image_url" name="image_url" id="info_pop_url" lay-verify="required|url" placeholder="素材大小建议不超过 100k " />
                </div>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(add)', function(data){
            ...
            layui.jquery.post('{:url("admin/admaterial4info/pop_edit_img")}',param,function(data){
