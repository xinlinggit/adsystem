...
<head>
    ...
    <style type="text/css">
        .icon-list{}
        .icon-list li{ float:left;width:30px;margin:2px;text-align:center;background:#f2f2f2;height:30px;overflow:hidden;padding:5px 5px 8px 5px;cursor:pointer;}
        .icon-list li i{font-size:30px!important;}
...
<body align="center">
    <div class="layui-tab layui-tab-card">
        <ul class="layui-tab-title">
            <li class="layui-this2"><a href="javascript:;">系统默认</a></li>
            <li><a href="javascript:;">Typicons</a></li>
            <li><a href="javascript:;">Font Awesome</a></li>
        </ul>
        <div class="layui-tab-content page-tab-content">
            ...
            <div class="layui-tab-item">
                <ul class="icon-list">
                    <li><i class="typcn typcn-adjust-brightness"></i></li>
                    <li><i class="typcn typcn-adjust-contrast"></i></li>
                    <li><i class="typcn typcn-anchor-outline"></i></li>
                    <li><i class="typcn typcn-anchor"></i></li>
                    <li><i class="typcn typcn-archive"></i></li>
                    <li><i class="typcn typcn-arrow-back-outline"></i></li>
                    <li><i class="typcn typcn-arrow-back"></i></li>
                    <li><i class="typcn typcn-arrow-down-outline"></i></li>
                    <li><i class="typcn typcn-arrow-down-thick"></i></li>
                    <li><i class="typcn typcn-arrow-down"></i></li>
                    <li><i class="typcn typcn-arrow-forward-outline"></i></li>
                    <li><i class="typcn typcn-arrow-forward"></i></li>
                    <li><i class="typcn typcn-arrow-left-outline"></i></li>
                    <li><i class="typcn typcn-arrow-left-thick"></i></li>
                    <li><i class="typcn typcn-arrow-left"></i></li>
                    <li><i class="typcn typcn-arrow-loop-outline"></i></li>
                    <li><i class="typcn typcn-arrow-loop"></i></li>
                    <li><i class="typcn typcn-arrow-maximise-outline"></i></li>
                    <li><i class="typcn typcn-arrow-maximise"></i></li>
                    <li><i class="typcn typcn-arrow-minimise-outline"></i></li>
                    <li><i class="typcn typcn-arrow-minimise"></i></li>
                    <li><i class="typcn typcn-arrow-move-outline"></i></li>
                    <li><i class="typcn typcn-arrow-move"></i></li>
                    <li><i class="typcn typcn-arrow-repeat-outline"></i></li>
                    <li><i class="typcn typcn-arrow-repeat"></i></li>
                    <li><i class="typcn typcn-arrow-right-outline"></i></li>
                    <li><i class="typcn typcn-arrow-right-thick"></i></li>
                    <li><i class="typcn typcn-arrow-right"></i></li>
                    <li><i class="typcn typcn-arrow-shuffle"></i></li>
                    <li><i class="typcn typcn-arrow-sorted-down"></i></li>
                    <li><i class="typcn typcn-arrow-sorted-up"></i></li>
                    <li><i class="typcn typcn-arrow-sync-outline"></i></li>
                    <li><i class="typcn typcn-arrow-sync"></i></li>
                    <li><i class="typcn typcn-arrow-unsorted"></i></li>
                    <li><i class="typcn typcn-arrow-up-outline"></i></li>
                    <li><i class="typcn typcn-arrow-up-thick"></i></li>
                    <li><i class="typcn typcn-arrow-up"></i></li>
                    <li><i class="typcn typcn-at"></i></li>
                    <li><i class="typcn typcn-attachment-outline"></i></li>
                    <li><i class="typcn typcn-attachment"></i></li>
                    <li><i class="typcn typcn-backspace-outline"></i></li>
                    <li><i class="typcn typcn-backspace"></i></li>
                    <li><i class="typcn typcn-battery-charge"></i></li>
                    <li><i class="typcn typcn-battery-full"></i></li>
                    <li><i class="typcn typcn-battery-high"></i></li>
                    <li><i class="typcn typcn-battery-low"></i></li>
                    <li><i class="typcn typcn-battery-mid"></i></li>
                    <li><i class="typcn typcn-beaker"></i></li>
                    <li><i class="typcn typcn-beer"></i></li>
                    <li><i class="typcn typcn-bell"></i></li>
                    <li><i class="typcn typcn-book"></i></li>
                    <li><i class="typcn typcn-bookmark"></i></li>
                    <li><i class="typcn typcn-briefcase"></i></li>
                    <li><i class="typcn typcn-brush"></i></li>
                    <li><i class="typcn typcn-business-card"></i></li>
                    <li><i class="typcn typcn-calculator"></i></li>
                    <li><i class="typcn typcn-calendar-outline"></i></li>
                    <li><i class="typcn typcn-calendar"></i></li>
                    <li><i class="typcn typcn-camera-outline"></i></li>
                    <li><i class="typcn typcn-camera"></i></li>
                    <li><i class="typcn typcn-cancel-outline"></i></li>
                    <li><i class="typcn typcn-cancel"></i></li>
                    <li><i class="typcn typcn-chart-area-outline"></i></li>
                    <li><i class="typcn typcn-chart-area"></i></li>
                    <li><i class="typcn typcn-chart-bar-outline"></i></li>
                    <li><i class="typcn typcn-chart-bar"></i></li>
                    <li><i class="typcn typcn-chart-line-outline"></i></li>
                    <li><i class="typcn typcn-chart-line"></i></li>
                    <li><i class="typcn typcn-chart-pie-outline"></i></li>
                    <li><i class="typcn typcn-chart-pie"></i></li>
                    <li><i class="typcn typcn-chevron-left-outline"></i></li>
                    <li><i class="typcn typcn-chevron-left"></i></li>
                    <li><i class="typcn typcn-chevron-right-outline"></i></li>
                    <li><i class="typcn typcn-chevron-right"></i></li>
                    <li><i class="typcn typcn-clipboard"></i></li>
                    <li><i class="typcn typcn-cloud-storage"></i></li>
                    <li><i class="typcn typcn-cloud-storage-outline"></i></li>
                    <li><i class="typcn typcn-code-outline"></i></li>
                    <li><i class="typcn typcn-code"></i></li>
                    <li><i class="typcn typcn-coffee"></i></li>
                    <li><i class="typcn typcn-cog-outline"></i></li>
                    <li><i class="typcn typcn-cog"></i></li>
                    <li><i class="typcn typcn-compass"></i></li>
                    <li><i class="typcn typcn-contacts"></i></li>
                    <li><i class="typcn typcn-credit-card"></i></li>
                    <li><i class="typcn typcn-css3"></i></li>
                    <li><i class="typcn typcn-database"></i></li>
                    <li><i class="typcn typcn-delete-outline"></i></li>
                    <li><i class="typcn typcn-delete"></i></li>
                    <li><i class="typcn typcn-device-desktop"></i></li>
                    <li><i class="typcn typcn-device-laptop"></i></li>
                    <li><i class="typcn typcn-device-phone"></i></li>
                    <li><i class="typcn typcn-device-tablet"></i></li>
                    <li><i class="typcn typcn-directions"></i></li>
                    <li><i class="typcn typcn-divide-outline"></i></li>
                    <li><i class="typcn typcn-divide"></i></li>
                    <li><i class="typcn typcn-document-add"></i></li>
                    <li><i class="typcn typcn-document-delete"></i></li>
                    <li><i class="typcn typcn-document-text"></i></li>
                    <li><i class="typcn typcn-document"></i></li>
                    <li><i class="typcn typcn-download-outline"></i></li>
                    <li><i class="typcn typcn-download"></i></li>
                    <li><i class="typcn typcn-dropbox"></i></li>
                    <li><i class="typcn typcn-edit"></i></li>
                    <li><i class="typcn typcn-eject-outline"></i></li>
                    <li><i class="typcn typcn-eject"></i></li>
                    <li><i class="typcn typcn-equals-outline"></i></li>
                    <li><i class="typcn typcn-equals"></i></li>
                    <li><i class="typcn typcn-export-outline"></i></li>
                    <li><i class="typcn typcn-export"></i></li>
                    <li><i class="typcn typcn-eye-outline"></i></li>
                    <li><i class="typcn typcn-eye"></i></li>
                    <li><i class="typcn typcn-feather"></i></li>
                    <li><i class="typcn typcn-film"></i></li>
                    <li><i class="typcn typcn-filter"></i></li>
                    <li><i class="typcn typcn-flag-outline"></i></li>
                    <li><i class="typcn typcn-flag"></i></li>
                    <li><i class="typcn typcn-flash-outline"></i></li>
                    <li><i class="typcn typcn-flash"></i></li>
                    <li><i class="typcn typcn-flow-children"></i></li>
                    <li><i class="typcn typcn-flow-merge"></i></li>
                    <li><i class="typcn typcn-flow-parallel"></i></li>
                    <li><i class="typcn typcn-flow-switch"></i></li>
                    <li><i class="typcn typcn-folder-add"></i></li>
                    <li><i class="typcn typcn-folder-delete"></i></li>
                    <li><i class="typcn typcn-folder-open"></i></li>
                    <li><i class="typcn typcn-folder"></i></li>
                    <li><i class="typcn typcn-gift"></i></li>
                    <li><i class="typcn typcn-globe-outline"></i></li>
                    <li><i class="typcn typcn-globe"></i></li>
                    <li><i class="typcn typcn-group-outline"></i></li>
                    <li><i class="typcn typcn-group"></i></li>
                    <li><i class="typcn typcn-headphones"></i></li>
                    <li><i class="typcn typcn-heart-full-outline"></i></li>
                    <li><i class="typcn typcn-heart-half-outline"></i></li>
                    <li><i class="typcn typcn-heart-outline"></i></li>
                    <li><i class="typcn typcn-heart"></i></li>
                    <li><i class="typcn typcn-home-outline"></i></li>
                    <li><i class="typcn typcn-home"></i></li>
                    <li><i class="typcn typcn-html5"></i></li>
                    <li><i class="typcn typcn-image-outline"></i></li>
                    <li><i class="typcn typcn-image"></i></li>
                    <li><i class="typcn typcn-infinity-outline"></i></li>
                    <li><i class="typcn typcn-infinity"></i></li>
                    <li><i class="typcn typcn-info-large-outline"></i></li>
                    <li><i class="typcn typcn-info-large"></i></li>
                    <li><i class="typcn typcn-info-outline"></i></li>
                    <li><i class="typcn typcn-info"></i></li>
                    <li><i class="typcn typcn-input-checked-outline"></i></li>
                    <li><i class="typcn typcn-input-checked"></i></li>
                    <li><i class="typcn typcn-key-outline"></i></li>
                    <li><i class="typcn typcn-key"></i></li>
                    <li><i class="typcn typcn-keyboard"></i></li>
                    <li><i class="typcn typcn-leaf"></i></li>
                    <li><i class="typcn typcn-lightbulb"></i></li>
                    <li><i class="typcn typcn-link-outline"></i></li>
                    <li><i class="typcn typcn-link"></i></li>
                    <li><i class="typcn typcn-location-arrow-outline"></i></li>
                    <li><i class="typcn typcn-location-arrow"></i></li>
                    <li><i class="typcn typcn-location-outline"></i></li>
                    <li><i class="typcn typcn-location"></i></li>
                    <li><i class="typcn typcn-lock-closed-outline"></i></li>
                    <li><i class="typcn typcn-lock-closed"></i></li>
                    <li><i class="typcn typcn-lock-open-outline"></i></li>
                    <li><i class="typcn typcn-lock-open"></i></li>
                    <li><i class="typcn typcn-mail"></i></li>
                    <li><i class="typcn typcn-map"></i></li>
                    <li><i class="typcn typcn-media-eject-outline"></i></li>
                    <li><i class="typcn typcn-media-eject"></i></li>
                    <li><i class="typcn typcn-media-fast-forward-outline"></i></li>
                    <li><i class="typcn typcn-media-fast-forward"></i></li>
                    <li><i class="typcn typcn-media-pause-outline"></i></li>
                    <li><i class="typcn typcn-media-pause"></i></li>
                    <li><i class="typcn typcn-media-play-outline"></i></li>
                    <li><i class="typcn typcn-media-play-reverse-outline"></i></li>
                    <li><i class="typcn typcn-media-play-reverse"></i></li>
                    <li><i class="typcn typcn-media-play"></i></li>
                    <li><i class="typcn typcn-media-record-outline"></i></li>
                    <li><i class="typcn typcn-media-record"></i></li>
                    <li><i class="typcn typcn-media-rewind-outline"></i></li>
                    <li><i class="typcn typcn-media-rewind"></i></li>
                    <li><i class="typcn typcn-media-stop-outline"></i></li>
                    <li><i class="typcn typcn-media-stop"></i></li>
                    <li><i class="typcn typcn-message-typing"></i></li>
                    <li><i class="typcn typcn-message"></i></li>
                    <li><i class="typcn typcn-messages"></i></li>
                    <li><i class="typcn typcn-microphone-outline"></i></li>
                    <li><i class="typcn typcn-microphone"></i></li>
                    <li><i class="typcn typcn-minus-outline"></i></li>
                    <li><i class="typcn typcn-minus"></i></li>
                    <li><i class="typcn typcn-mortar-board"></i></li>
                    <li><i class="typcn typcn-news"></i></li>
                    <li><i class="typcn typcn-notes-outline"></i></li>
                    <li><i class="typcn typcn-notes"></i></li>
                    <li><i class="typcn typcn-pen"></i></li>
                    <li><i class="typcn typcn-pencil"></i></li>
                    <li><i class="typcn typcn-phone-outline"></i></li>
                    <li><i class="typcn typcn-phone"></i></li>
                    <li><i class="typcn typcn-pi-outline"></i></li>
                    <li><i class="typcn typcn-pi"></i></li>
                    <li><i class="typcn typcn-pin-outline"></i></li>
                    <li><i class="typcn typcn-pin"></i></li>
                    <li><i class="typcn typcn-pipette"></i></li>
                    <li><i class="typcn typcn-plane-outline"></i></li>
                    <li><i class="typcn typcn-plane"></i></li>
                    <li><i class="typcn typcn-plug"></i></li>
                    <li><i class="typcn typcn-plus-outline"></i></li>
                    <li><i class="typcn typcn-plus"></i></li>
                    <li><i class="typcn typcn-point-of-interest-outline"></i></li>
                    <li><i class="typcn typcn-point-of-interest"></i></li>
                    <li><i class="typcn typcn-power-outline"></i></li>
                    <li><i class="typcn typcn-power"></i></li>
                    <li><i class="typcn typcn-printer"></i></li>
                    <li><i class="typcn typcn-puzzle-outline"></i></li>
                    <li><i class="typcn typcn-puzzle"></i></li>
                    <li><i class="typcn typcn-radar-outline"></i></li>
                    <li><i class="typcn typcn-radar"></i></li>
                    <li><i class="typcn typcn-refresh-outline"></i></li>
                    <li><i class="typcn typcn-refresh"></i></li>
                    <li><i class="typcn typcn-rss-outline"></i></li>
                    <li><i class="typcn typcn-rss"></i></li>
                    <li><i class="typcn typcn-scissors-outline"></i></li>
                    <li><i class="typcn typcn-scissors"></i></li>
                    <li><i class="typcn typcn-shopping-bag"></i></li>
                    <li><i class="typcn typcn-shopping-cart"></i></li>
                    <li><i class="typcn typcn-social-at-circular"></i></li>
                    <li><i class="typcn typcn-social-dribbble-circular"></i></li>
                    <li><i class="typcn typcn-social-dribbble"></i></li>
                    <li><i class="typcn typcn-social-facebook-circular"></i></li>
                    <li><i class="typcn typcn-social-facebook"></i></li>
                    <li><i class="typcn typcn-social-flickr-circular"></i></li>
                    <li><i class="typcn typcn-social-flickr"></i></li>
                    <li><i class="typcn typcn-social-github-circular"></i></li>
                    <li><i class="typcn typcn-social-github"></i></li>
                    <li><i class="typcn typcn-social-google-plus-circular"></i></li>
                    <li><i class="typcn typcn-social-google-plus"></i></li>
                    <li><i class="typcn typcn-social-instagram-circular"></i></li>
                    <li><i class="typcn typcn-social-instagram"></i></li>
                    <li><i class="typcn typcn-social-last-fm-circular"></i></li>
                    <li><i class="typcn typcn-social-last-fm"></i></li>
                    <li><i class="typcn typcn-social-linkedin-circular"></i></li>
                    <li><i class="typcn typcn-social-linkedin"></i></li>
                    <li><i class="typcn typcn-social-pinterest-circular"></i></li>
                    <li><i class="typcn typcn-social-pinterest"></i></li>
                    <li><i class="typcn typcn-social-skype-outline"></i></li>
                    <li><i class="typcn typcn-social-skype"></i></li>
                    <li><i class="typcn typcn-social-tumbler-circular"></i></li>
                    <li><i class="typcn typcn-social-tumbler"></i></li>
                    <li><i class="typcn typcn-social-twitter-circular"></i></li>
                    <li><i class="typcn typcn-social-twitter"></i></li>
                    <li><i class="typcn typcn-social-vimeo-circular"></i></li>
                    <li><i class="typcn typcn-social-vimeo"></i></li>
                    <li><i class="typcn typcn-social-youtube-circular"></i></li>
                    <li><i class="typcn typcn-social-youtube"></i></li>
                    <li><i class="typcn typcn-sort-alphabetically-outline"></i></li>
                    <li><i class="typcn typcn-sort-alphabetically"></i></li>
                    <li><i class="typcn typcn-sort-numerically-outline"></i></li>
                    <li><i class="typcn typcn-sort-numerically"></i></li>
                    <li><i class="typcn typcn-spanner-outline"></i></li>
                    <li><i class="typcn typcn-spanner"></i></li>
                    <li><i class="typcn typcn-spiral"></i></li>
                    <li><i class="typcn typcn-star-full-outline"></i></li>
                    <li><i class="typcn typcn-star-half-outline"></i></li>
                    <li><i class="typcn typcn-star-half"></i></li>
                    <li><i class="typcn typcn-star-outline"></i></li>
                    <li><i class="typcn typcn-star"></i></li>
                    <li><i class="typcn typcn-starburst-outline"></i></li>
                    <li><i class="typcn typcn-starburst"></i></li>
                    <li><i class="typcn typcn-stopwatch"></i></li>
                    <li><i class="typcn typcn-support"></i></li>
                    <li><i class="typcn typcn-tabs-outline"></i></li>
                    <li><i class="typcn typcn-tag"></i></li>
                    <li><i class="typcn typcn-tags"></i></li>
                    <li><i class="typcn typcn-th-large-outline"></i></li>
                    <li><i class="typcn typcn-th-large"></i></li>
                    <li><i class="typcn typcn-th-list-outline"></i></li>
                    <li><i class="typcn typcn-th-list"></i></li>
                    <li><i class="typcn typcn-th-menu-outline"></i></li>
                    <li><i class="typcn typcn-th-menu"></i></li>
                    <li><i class="typcn typcn-th-small-outline"></i></li>
                    <li><i class="typcn typcn-th-small"></i></li>
                    <li><i class="typcn typcn-thermometer"></i></li>
                    <li><i class="typcn typcn-thumbs-down"></i></li>
                    <li><i class="typcn typcn-thumbs-ok"></i></li>
                    <li><i class="typcn typcn-thumbs-up"></i></li>
                    <li><i class="typcn typcn-tick-outline"></i></li>
                    <li><i class="typcn typcn-tick"></i></li>
                    <li><i class="typcn typcn-ticket"></i></li>
                    <li><i class="typcn typcn-time"></i></li>
                    <li><i class="typcn typcn-times-outline"></i></li>
                    <li><i class="typcn typcn-times"></i></li>
                    <li><i class="typcn typcn-trash"></i></li>
                    <li><i class="typcn typcn-tree"></i></li>
                    <li><i class="typcn typcn-upload-outline"></i></li>
                    <li><i class="typcn typcn-upload"></i></li>
                    <li><i class="typcn typcn-user-add-outline"></i></li>
                    <li><i class="typcn typcn-user-add"></i></li>
                    <li><i class="typcn typcn-user-delete-outline"></i></li>
                    <li><i class="typcn typcn-user-delete"></i></li>
                    <li><i class="typcn typcn-user-outline"></i></li>
                    <li><i class="typcn typcn-user"></i></li>
                    <li><i class="typcn typcn-vendor-android"></i></li>
                    <li><i class="typcn typcn-vendor-apple"></i></li>
                    <li><i class="typcn typcn-vendor-microsoft"></i></li>
                    <li><i class="typcn typcn-video-outline"></i></li>
                    <li><i class="typcn typcn-video"></i></li>
                    <li><i class="typcn typcn-volume-down"></i></li>
                    <li><i class="typcn typcn-volume-mute"></i></li>
                    <li><i class="typcn typcn-volume-up"></i></li>
                    <li><i class="typcn typcn-volume"></i></li>
                    <li><i class="typcn typcn-warning-outline"></i></li>
                    <li><i class="typcn typcn-warning"></i></li>
                    <li><i class="typcn typcn-watch"></i></li>
                    <li><i class="typcn typcn-waves-outline"></i></li>
                    <li><i class="typcn typcn-waves"></i></li>
                    <li><i class="typcn typcn-weather-cloudy"></i></li>
                    <li><i class="typcn typcn-weather-downpour"></i></li>
                    <li><i class="typcn typcn-weather-night"></i></li>
                    <li><i class="typcn typcn-weather-partly-sunny"></i></li>
                    <li><i class="typcn typcn-weather-shower"></i></li>
                    <li><i class="typcn typcn-weather-snow"></i></li>
                    <li><i class="typcn typcn-weather-stormy"></i></li>
                    <li><i class="typcn typcn-weather-sunny"></i></li>
                    <li><i class="typcn typcn-weather-windy-cloudy"></i></li>
                    <li><i class="typcn typcn-weather-windy"></i></li>
                    <li><i class="typcn typcn-wi-fi-outline"></i></li>
                    <li><i class="typcn typcn-wi-fi"></i></li>
                    <li><i class="typcn typcn-wine"></i></li>
                    <li><i class="typcn typcn-world-outline"></i></li>
                    <li><i class="typcn typcn-world"></i></li>
                    <li><i class="typcn typcn-zoom-in-outline"></i></li>
                    <li><i class="typcn typcn-zoom-in"></i></li>
                    <li><i class="typcn typcn-zoom-out-outline"></i></li>
                    <li><i class="typcn typcn-zoom-out"></i></li>
                    <li><i class="typcn typcn-zoom-outline"></i></li>
                    <li><i class="typcn typcn-zoom"></i></li>
                </ul>
            </div>
            <div class="layui-tab-item">
                <ul class="icon-list">
                    ...
                    <li><i class="fa fa-drivers-license"></i></li>
                    <li><i class="fa fa-id-card"></i></li>
                    <li><i class="fa fa-drivers-license-o"></i></li>
                    ...
                    <li><i class="fa fa-times-rectangle"></i></li>
                    <li><i class="fa fa-window-close"></i></li>
                    <li><i class="fa fa-times-rectangle-o"></i></li>
                    <li><i class="fa fa-window-close-o"></i></li>
                    <li><i class="fa fa-bandcamp"></i></li>
                    <li><i class="fa fa-grav"></i></li>
                    <li><i class="fa fa-etsy"></i></li>
                    <li><i class="fa fa-imdb"></i></li>
                    <li><i class="fa fa-ravelry"></i></li>
                    <li><i class="fa fa-eercast"></i></li>
                    <li><i class="fa fa-microchip"></i></li>
                    <li><i class="fa fa-snowflake-o"></i></li>
                    <li><i class="fa fa-superpowers"></i></li>
                    <li><i class="fa fa-wpexplorer"></i></li>
                    <li><i class="fa fa-meetup"></i></li>
                </ul>
            </div>
        </div>
    </div>
...
layui.use(['jquery', 'element'], function() {
    ...
    $('.icon-list li').click(function(){
        var _val = $(this).find('i').attr('class');
