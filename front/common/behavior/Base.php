...
class Base
{
    public function run(&$params)
    {
        ...
        $view_replace_str = [
            ...
            // 静态资源根目录
            '__STATIC__'    => ROOT_DIR.'statics',
            // 文件上传目录
            '__UPLOAD__'   => ROOT_DIR.'upload',
            // 插件目录
            '__PLUGINS__' => ROOT_DIR.'plugins',
            // 后台公共静态目录
            '__ADMIN_CSS__'      => ROOT_DIR.'statics/admin/css',
            '__ADMIN_JS__'      => ROOT_DIR.'statics/admin/js',
            '__ADMIN_IMG__'      => ROOT_DIR.'statics/admin/image',
            // 后台模块静态目录
            '__ADMIN_MOD_CSS__'      => ROOT_DIR.'statics/'.$module.'/css',
            '__ADMIN_MOD_JS__'      => ROOT_DIR.'statics/'.$module.'/js',
            '__ADMIN_MOD_IMG__'      => ROOT_DIR.'statics/'.$module.'/image',
            // 前台公共静态目录
            '__PUBLIC_CSS__'      => ROOT_DIR.'statics/css',
            '__PUBLIC_JS__'      => ROOT_DIR.'statics/js',
            '__PUBLIC_IMG__'      => ROOT_DIR.'statics/image',
            // 前台模块静态目录
