...
(function (e) {
    var ins=domGetTag('ins'),il=ins.length,ia=new Array(),ib=new Array(),api="http://as.cnfol.com/index/index/api_preview";
    var f={
        load:function(a,n,p){
            var t=eval('('+p+')');
            if(t.code=="100"){
        ...
        ajax:function(a,c){
            ...
            h.open("GET", api+"?material_id="+a+'&t='+Math.random(), true);
