...
namespace api\apilib\controller;
...
class BaseAuth extends controller\Api
{
    /**
     * 错误
     */
...
//        }
    ...
    protected function getClient($client_id)
    {
        return [
            ...
            'authorization_list' => 'api/User/init,',//权限列表
        ];
    }
     ...
     * @return bool
     */
    protected static function verifyPermissions(Request $request, $accessTokenInfo)
    {
        //获取allModule
